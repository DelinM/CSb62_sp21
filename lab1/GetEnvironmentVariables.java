...
public class GetEnvironmentVariables {
    ...
    public static String REPO_DIR = "/Users/delinmu/Documents/GitHub/CSb62_sp21";

    //  Fill in the path to your snaps-sp21-s*** folder between the quotes
    public static String SNAPS_DIR = "";

    // Fill in the type of your shell by running 'echo $0` in your terminal.ß It should be zsh or bash.
